    ...
    <main>
      ...
      <section class="home-section-top">
        <div class="home-section-content">
          <div>
            <div class="home-section-content-title"><span>당신 근처의 공유 킥보드</span><br /><span class="home-section-content-title-sub">아보카도!</span></div>
            <p class="home-section-content-text">가까운 곳부터 멀리까지, 아보카도와 함께 해요.<br />편한 당신의 라이프스타일을 위해.</p>
          </div>
          <div class="home-section-content-img animate__animated animate__fadeInRightBig"><img src="img/main-top-img.png" alt="" /></div>
        </div>
      </section>
      <!-- section01 end-->
      <!-- section02 start-->
      ...
      <section class="home-section" style="background-color: floralwhite">
        <div class="home-section-content">
          <div class="how-to-use-container">
            <div class="how-to-use-title"><h1>쉽고 편리한 아보카도!</h1></div>
            <br />
            <ul>
              <li>
                <p class="how-to-use-txt">가입 하고,</p>
                <p>회원 가입 후에 본인 인증을 해주세요.</p>
                <br />
              </li>
              <li>
                <p class="how-to-use-txt">헬멧 쓰고,</p>
                <p>안전을 위해서 보호장구를 착용해주세요.</p>
                <br />
              </li>
              <li>
                <p class="how-to-use-txt">킥보드를 찾고,</p>
                <p>이용 금액을 충전한 다음, 내 주변에 있는 아보카도를 찾아보세요.</p>
                <br />
              </li>
              <li>
                <p class="how-to-use-txt">킥보드를 타고,</p>
                <p>QR코드 스캔 또는 일련번호를 입력하여 잠금장치를 해제 후 주행해보세요.</p>
                <br />
              </li>
              <li>
                <p class="how-to-use-txt">반납하면, 끝.</p>
                <p>안전한 장소에 킥보드를 주차하고 사용 종료를 누르면 끝. 참 쉽죠?</p>
                <br />
              </li>
            </ul>
          </div>
          ...
          <div class="for-safe-container">
            ...
            <div class="for-safe-box">
              ...
              <div class="for-safe-box-txt">
                ...
                <p class="for-safe-box-txt-content">음주 후 탑승은 법률에 의해<br />처벌 대상에 해당돼요.</p>
              </div>
            </div>
            <div class="for-safe-box">
              <div class="for-safe-box-img">
              ...
              <div class="for-safe-box-txt">
                ...
                <p class="for-safe-box-txt-content">보행자 우선 지역입니다.<br />킥보드는 주행하면 안 돼요!</p>
              </div>
            </div>
            <div class="for-safe-box">
              <div class="for-safe-box-img">
            ...
            <div class="for-safe-box">
              ...
              <div class="for-safe-box-txt">
                ...
                <p class="for-safe-box-txt-content">2인 이상 탑승은 위험해요.<br />반드시 회원 본인만 탑승하세요.</p>
              </div>
            </div>
            <div class="for-safe-box">
              <div class="for-safe-box-img">
              ...
              <div class="for-safe-box-txt">
                ...
                <p class="for-safe-box-txt-content">갑작스러운 방향 전환, 급 감속,<br />정지를 하면 안 돼요!</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <!-- section04 end-->
      <!-- section05 start-->
      <section class="home-section" style="background: #f8f9fa; height: 230px">
        <div class="home-section-content">
          <div class="faq-title"><h1>자주 묻는 질문</h1></div>
          <!--https://theswing.co.kr/faq-->
          <div class="faq-box-container">
            <div class="faq-box">
              <a href="/Faq"
                ><button class="faq-box-button"><p class="faq-box-txt-title">운영시간</p></button></a
              >
            </div>
            <div class="faq-box">
              <a href="/Faq"
                ><button class="faq-box-button"><p class="faq-box-txt-title">서비스 이용</p></button></a
              >
            </div>
            <div class="faq-box">
              <a href="/Faq"
                ><button class="faq-box-button"><p class="faq-box-txt-title">고장(장애)</p></button></a
              >
            </div>
            <div class="faq-box">
              <a href="/Faq"
                ><button class="faq-box-button"><p class="faq-box-txt-title">계정 관련</p></button></a
              >
            </div>
            <div class="faq-box">
              <a href="/Faq"
                ><button class="faq-box-button"><p class="faq-box-txt-title">결제 및 패널티</p></button></a
              >
            </div>
            <div class="faq-box">
              <a href="/Faq"
                ><button class="faq-box-button"><p class="faq-box-txt-title">주차</p></button></a
              >
            </div>
          </div>
        </div>
