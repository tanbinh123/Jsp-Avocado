...
<%@ include file="/common/header.jsp" %>
            ...
            <div id="map">
                <div class="map-infoPanel">
                    ...
                    <div class="map-infoPanel-using">
                        <p class="map-infoPanel-using-text"><i class="em em-avocado" aria-role="presentation" aria-label="AVOCADO"></i>&nbsp;홍길동님 안전 주행하세요 :) </p>
                        ...
                        <p class="map-infoPanel-using-text"><i class="em em-clock7" aria-role="presentation" aria-label="CLOCK FACE SEVEN OCLOCK"></i>&nbsp;현재 이용 시간 : 15분 31초</p>
    ...
    <script>
        var serviceArea = new naver.maps.LatLngBounds(
            new naver.maps.LatLng(36.439988, 127.264349),
            new naver.maps.LatLng(36.232447, 127.534364));
        ...
        var polygon = new naver.maps.Polygon({  
            map: map,
            paths: [outerPolygon, innerPolygon,samsungAPT, miruAPT, centralXiAPT, hanbatXiAPT,sunwhaHyeondaeAPT,daeheongHyeondaeAPT, theShopAPT],
            fillColor: '#558203',
            fillOpacity: 0.1,
            strokeColor: '#558203',
            strokeOpacity: 0.6,
